...
- [📖 \[Budget-App\] ](#-hello-rails-back-end-)
...
A rails backend API application for implementing a connection between a Ruby on Rails back-end and React front-end.
...
[React app](https://github.com/Enning94/hello-react-front-end)
...
```sh
  git clone git@github.com:Enning94/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/Enning94/hello-rails-back-end/issues).
